...
1. Docker Compose: definicja i orchestracja serwisów
...
2. **Requirements per kontener:** NIGDY uniwersalnych requirements - każdy kontener ma OSOBNY plik zależności, minimum bibliotek
